...
**1.** **Introdução** **1** 1. Quais as perguntas que este projeto
pretende responder? 1

**2.** **Fontes** **de** **Dados** **2** 1. Quais as fontes dos dados? 2
2. Privacidade dos Dados 2

**3.** **Extração** **dos** **Dados** **3** 1. Ferramentas Utilizadas 3
2. Coleta dos dados 3

**4.** **Modelagem** **dos** **Dados** **4** 1. Descrição 4 2. Diagrama
Modelo Snowflake 4

**5.** **Catálogo** **de** **Dados** **5** 1. Tabelas de Portais de
Imóveis (fonte de dados) 5 2. Tabelas de Cidades e Consolidação de
Imóveis 6 3. Tabelas de CEP (Dados Geográficos) 7 4. Tabelas GeoBase 7

**6.** **ETL** **Databricks** **8** **7.** **Análise** **dos** **Dados**
**10** **8.** **Respostas** **às** **perguntas** **14** **9.**
**Autoavaliação** **15** **10.** **Conclusão** **16**
...
<![Extração Scrapy](https://github.com/BLayus/MVP_PUC_Rio_Eng_Dados/blob/main/Img/ScreenShot_Web%20Scraping.png)
...
<img src="./iwvvkzc4.png"
style="width:6.78624in;height:4.44466in" />Extração via linha de comando
Bash para acessar APIs
...
>
> <img src="./w3mddqm0.png"
> style="width:7.50646in;height:5.77318in" />5
>
> 5\. **Catálogo** **de** **Dados**
>
...
<img src="./k54bwc2d.png"
style="width:9.6323in;height:3.68048in" /><img src="./25osr0jd.png"
style="width:6.16702in;height:4.95036in" />

experimentar, uma parte foi feita em SQL, apesar de ser menos eficiente
...
análise, como por exemplo: bases do ibge ou do ipea com dados

sócio-econômicos.

> 10

<img src="./yznckncj.png"
style="width:6.27083in;height:1.94792in" /><img src="./0pvnuohq.png"
style="width:6.27083in;height:1.78125in" />
...
Paulo. Apesar das comparações por média

> 11

<img src="./nzflh15k.png"
style="width:6.65625in;height:3.48958in" />

serem pouco precisas, por experiência e por comprovação dos dados,
...
disponíveis no mercado e como

> 12

<img src="./kcs30aje.png"
style="width:6.33333in;height:3.30208in" /><img src="./yyetzyw3.png"
style="width:6.30208in;height:3.9375in" />

o preço pode variar de acordo com esta característica. Faz um pouco
...
<img src="./l0it1yr5.png" style="width:6.73958in;height:3.5in" />
...
valorizados pode girar em torno de
